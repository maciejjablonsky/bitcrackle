...
Item {
    ...
    property color error: "#A44A3F"       // Warning Red Clay
    property color onError: "#D9CBB0"     // Bamboo Cream
    property color border: "#4B3621"     // Dark Soil Brown
    property color disabled: "#7D7461"   // Temple Stone
    property color onDisabled: "#A6A6A6" // Mist Grey
}
